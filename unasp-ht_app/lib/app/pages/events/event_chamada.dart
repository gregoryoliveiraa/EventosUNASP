...
class Chamada extends StatefulWidget {
  final String evento;
  const Chamada({Key key, this.evento}) : super(key: key);
  @override
...
class _ChamadaState extends State<Chamada> {
  ...
  Future _scanQR() async {
    try {
      setState(() {
        barcodeString = QRCodeReader().scan();
  ...
  // void checkingValue(Future<String> barcodeString) {
  //   if (result != null || result != '') {
  //     print('>>>>>>>>>>>>>>>>>>>>>>>>>>' + result);      
  //   } else {
  //     return null;
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton.extended(          
          ...
          label: Text('Escanear', style: TextStyle(fontSize: 20, color: Colors.grey[100], height: 1.4,)),
